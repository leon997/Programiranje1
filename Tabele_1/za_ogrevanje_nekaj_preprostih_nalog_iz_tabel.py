# =============================================================================
# Za "ogrevanje" - nekaj preprostih nalog iz tabel
# =====================================================================@019006=
# 1. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjozMzA3LCJwYXJ0IjoxOTAwNn0:1gQ9Ys:GT7RrrXD9x7e0ejliRJOsnXQ99o'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjozMzA3LCJwYXJ0IjoxOTAwN30:1gQ9Ys:nr1UOMZ_JKURrH5b6pAM8LaJb4E'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjozMzA3LCJwYXJ0IjoxOTAwOH0:1gQ9Ys:1RlJHBXI3uXuo6dwYopzWXhPI1E'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjozMzA3LCJwYXJ0IjoxOTAwOX0:1gQ9Ys:PFLvSo0h9GxjuATfV7Byz6shZyo'
        try:
