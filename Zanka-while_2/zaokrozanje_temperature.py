...
#
# Da se še malo spomnimo na funkcije in stavek if!
# 
# Naloga izvira iz Tekmovanja RTK 2017
# =====================================================================@018526=
# 1. podnaloga
...
# zamiki vrstic pa pobrisali. Uredi vrstice tako, da bo funkcija zopet delovala. Seveda
# dodaj še ustrezne komentarje in dok. komentar!
# 
#       def zaokrozi(x):
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjozMzA3LCJwYXJ0IjoxODUyNn0:1gKOPE:rfuTQtfPidUjBNYVGFO81RNxfuA'
        try:
            (
                Check.equal('zaokrozi(3.123)', '3') and
                Check.equal('zaokrozi(0.5)', '1') and
                Check.equal('zaokrozi(0)', '0') and
                Check.equal('zaokrozi(99.999)', '100') and
                Check.equal('zaokrozi(-99.5)', '-99') and
                Check.equal('zaokrozi(4.3281578361586)', '4') and
                Check.equal('zaokrozi(-4.3281578361586)', '-4') and
                Check.equal('zaokrozi(6.87365187637586)', '7') and
                Check.equal('zaokrozi(-6.87365187637586)', '-7')
            )
            Check.secret(zaokrozi(-0.5), "Si natančno upošteval meje?")
        except:
